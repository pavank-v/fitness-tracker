...
const ProtectedRoute = ({ children })=>{
    ...
    const refresh = async ()=>{
        const refreshToken = localStorage.getItem(__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$constant$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["REFRESH_TOKEN"]);
        try {
            const res = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].post("auth/token/refresh", {
                refresh: refreshToken
            });
            if (res.status === 200) {
                setIsAuthorized(1);
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__c8b91c._.js.map