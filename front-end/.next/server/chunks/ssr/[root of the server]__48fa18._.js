...
api.interceptors.request.use((config)=>{
    const token = localStorage.getItem(__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$constant$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ACCESS_TOKEN"]);
    if (token) {
...
api.interceptors.response.use((response)=>response, async (error)=>{
    ...
    if (error.response?.status == 401 && !originalRequest._retry) {
        ...
        const refreshToken = localStorage.getItem(__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$constant$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["REFRESH_TOKEN"]);
        if (refreshToken) {
            try {
                ...
                if (res.status === 200) {
                    ...
                    localStorage.setItem(__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$constant$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ACCESS_TOKEN"], newAccessToken);
                ...
                localStorage.removeItem(__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$constant$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ACCESS_TOKEN"]);
                localStorage.removeItem(__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$constant$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["REFRESH_TOKEN"]);
...
const Register = ()=>{
    ...
    const handleSubmit = async (e)=>{
        ...
        setError("");
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].post("/auth/user/", registrationData);
            if (response.status == 200) {
                localStorage.setItem(__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$constant$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ACCESS_TOKEN"], response.data.access);
                localStorage.setItem(__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$constant$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["REFRESH_TOKEN"], response.data.refresh);
                navigate("/auth/login");
            }
        } catch (err) {
...
const Login = ()=>{
    ...
    const handleSubmit = async (e)=>{
        ...
        setError('');
        try {
            const res = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].post("auth/token/", formData);
            if (res.status === 200) {
                localStorage.setItem(__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$constant$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ACCESS_TOKEN"], res.data.access);
                localStorage.setItem(__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$constant$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["REFRESH_TOKEN"], res.data.refresh);
                navigate("/");
            }
        } catch (err) {
            console.log("Login Error", err);
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__48fa18._.js.map