...
const Header = () => {
  ...
  return (
    <>
      <div className="sticky top-5 z-10 bg-black/30 py-2 backdrop-blur-3xl border border-gray-600 rounded-full max-w-4xl mx-2 md:mx-3 lg:mx-auto">
        <div className="flex items-center justify-between px-5">
          ...
          <div className="flex items-center gap-4">
            <div className="hidden sm:block space-x-2 text-white font-medium">
              <a href="#" className="text-gray-300/85 hover:bg-gradient-to-r hover:from-cyan-500 
              hover:to-cyan-700 hover:text-transparent hover:bg-clip-text px-3">Log In</a>
              <a href="#" className="text-gray-300/85 hover:bg-gradient-to-r hover:from-cyan-500 
              hover:to-cyan-700 hover:text-transparent hover:bg-clip-text px-3">Sign In</a>
            </div>
      ...
      {mobileMenuOpen && (
        <div className="lg:hidden fixed inset-0 z-50 bg-gray-900/95 pt-20">
          ...
          <div className="flex flex-col items-center px-4 py-6 space-y-6">
            <a href="#" className="text-white text-lg font-medium py-2 hover:text-cyan-400 transition">Log In</a>
            <a href="#" className="text-white text-lg font-medium py-2 hover:text-cyan-400 transition">Sign In</a>
